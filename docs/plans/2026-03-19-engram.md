...
**Spec:** `docs/superpowers/specs/2026-03-19-engram-design.md`
...
engram/
  ...
  docs/
    superpowers/
      specs/
        2026-03-19-engram-design.md   # (already exists)
      plans/
        2026-03-19-engram.md          # (this file)
```
...
```json
{
  ...
  "repository": "https://github.com/rmngrc/engram",
  "license": "MIT",
  "keywords": [
    "memory",
    "obsidian",
